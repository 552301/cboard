...
public class OtherService {
    ...
    public String doOther(DashboardJob job) throws Exception {
    	System.out.println("其它定时任务执行中");
    	System.out.println(job.getJobType().toString());
    	System.out.println(job.getName().toString());
    	return null;
    }
}
