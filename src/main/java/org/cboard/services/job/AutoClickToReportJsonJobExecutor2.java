...
public class AutoClickToReportJsonJobExecutor2 implements Job {

	private static final Logger LOG = LoggerFactory.getLogger(AutoClickToReportJsonJobExecutor2.class);
	...
	private void mainJob() {
		String sn = "自动点击获取报表Json数据定时任务2>>";
		// 可执行文件完整路径
		String exeFullPath = "D:\\tools\\CBoardAutoClicker\\CBoardAutoClicker.exe ";
