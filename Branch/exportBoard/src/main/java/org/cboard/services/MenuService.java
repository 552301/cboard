...
public class MenuService {
    ...
    static {
        ...
        //menuList.add(new DashboardMenu(11, 1, "SIDERBAR.SALESTARGET", "config.target"));
        menuList.add(new DashboardMenu(12, 1, "SIDERBAR.DAYSALESTARGET", "config.daySalesTarget"));
        menuList.add(new DashboardMenu(13, 1, "SIDERBAR.DAYSALESB2B", "config.daySalesB2B"));
        menuList.add(new DashboardMenu(14, 1, "SIDERBAR.DAYRETURNB2B", "config.dayReturnB2B"));
    }
