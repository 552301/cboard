...
public class AdminSerivce {
    ...
    public String addRole(String roleId, String roleName, String userId ,String brandName) {
        DashboardRole role = new DashboardRole();
        role.setRoleId(roleId);
        role.setRoleName(roleName);
        role.setUserId(userId);
        role.setBrandName(brandName);
        roleDao.save(role);
        return "1";
    }

    public String updateRole(String roleId, String roleName, String userId ,String brandName) {
        DashboardRole role = new DashboardRole();
        role.setRoleId(roleId);
        role.setRoleName(roleName);
        role.setUserId(userId);
