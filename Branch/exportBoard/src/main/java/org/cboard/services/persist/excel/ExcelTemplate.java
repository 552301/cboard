...
public class ExcelTemplate {
	...
	public void parse(HttpServletRequest request) {
		...
		if(CboardUtils.isEmpty(templatePath)){
			log.error(CboardConstants.Exception_Head + "Excel模板路径不能为空!");
		}
		...
		if(CboardUtils.isEmpty(is)){
			log.error(CboardConstants.Exception_Head + "未找到模板文件,请确认模板路径是否正确[" + templatePath + "]");
		}
